...
if __name__ == '__main__':
    ...
    individuals_affected_median = texas_hacking['Individuals Affected'].median(
    )
    ...
    individuals_affected_mode = texas_hacking['Individuals Affected'].mode()
    ...
    # value
    individuals_affected_std = texas_hacking['Individuals Affected'].std()
    print('Texas hacking standart deviation:',
